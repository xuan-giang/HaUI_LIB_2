                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="author" class="form-control"
                                                                   placeholder="Nhập họ tên tác giả" value="{{ $book->author }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="amount"
                                                                   class="form-control" value="{{ $book->amount }}">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" name="publisher" class="form-control"
                                                                   placeholder="Nhập tên nhà xuất bản" value="{{ $book->publisher }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <h5>Số trang</h5>
                                                        <div class="controls">
                                                            <input type="text" name="page" class="form-control"
                                                                   placeholder="Nhập số trang" value="{{ $book->page }}">
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <h5>Giá niêm yết</h5>
                                                        <div class="controls">
                                                            <input type="text" name="price" class="form-control"
                                                                   placeholder="Nhập giá niêm yết sau bìa sách" value="{{ $book->price }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
